...
const Item = ({ bold, info, date, body, extra }, key) => (
	<li className="row" key={key} style={{ borderRadius: '20px', padding: '10px' }}>
		{bold && <div>
			<b>{bold}</b>
		</div>}
		{info && <div>
...
module.exports = { Topper, SectionHeader, makeReleaseLink, AudioPlayer, typeToDisplay, makeSubject, FormatDate, makeDate, Item, makeAuthor };
