...
const AudioPlayer = (props) => {
	console.log("PORP", props.comment);
...
export { getBodyHTML, Topper, SectionHeader, makeMusicianLink, makeReleaseLink, AudioPlayer, typeToDisplay, makeSubject, FormatDate, makeDate, Item, makeAuthor, dateCompare, makeBandLink, makeSource };
