import { getBodyHTML, AudioPlayer } from './helpers';
...
you saw that red recording light go on..........
			...
			},
			{
				...
				body: <>
<AudioPlayer title="RIDE THE COUNTY ROAD (ASCAP)" band="Dan Modlin" mp3="DanModlin_RideTheCountryRoad_2004.mp3" date="2004-03-15"/>
<p className="lyrics">
...
It was an experience not to be forgotten. Our first visit to a real studio. This event impacted at least two of the band members. John has his own home studio now. Rick still plays and does recording work at his cousin's home studio. Plus he has his own home studio for mastering their covers and originals.
	...
	},
	{
		...
		liner: ``,
		mastering: ``,
		title: `Ride The Country Road (Mo's Song)`,
		id: ``,
		...
		tracks: [
			{
				...
				affiliation: `ASCAP`,
				comment: getBodyHTML(<p className="lyrics">
						You had to know just where to turn<br/>
						It was a little county road with a driveway that wound thru a cornfield<br/>
						Out at 700 West, he gave the bands a chance and they gave it their best---<br/>
						and it sure showed.......<br/>
		...
		tracks: [
			{
				...
				audio: 'https://tapes.700west.com/api/audio/Malachi_Demo/04.01.mp3',
			},
			{
				tracknum: '2',
				artist: `Malachi`,
				title: `You Won't See Me (Beatles)`,
				audio: 'https://tapes.700west.com/api/audio/Malachi_Demo/04.02.mp3',
			},
			{
				tracknum: '3',
				artist: `Malachi`,
				title: `I-94 riff (Rastus)`,
				audio: 'https://tapes.700west.com/api/audio/Malachi_Demo/04.03.mp3',
			},
			{
				tracknum: '4',
				artist: `Malachi`,
				title: `Beginnings (Chicago)`,
				audio: 'https://tapes.700west.com/api/audio/Malachi_Demo/04.04.mp3',
			},
			{
				tracknum: '5',
				artist: `Malachi`,
				title: `It's Too Late (Carole King)`,
				audio: 'https://tapes.700west.com/api/audio/Malachi_Demo/04.05.mp3',
			},
			{
				tracknum: '6',
				artist: `Malachi`,
				title: `Saturday (In the park) (Chicago)`,
				audio: 'https://tapes.700west.com/api/audio/Malachi_Demo/04.06.mp3',
			},
		],
		comments: [
			{
