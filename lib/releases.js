...
<b>Tom Noonan</b>
	...
	},
	{
		...
		comments: [
			{
				date: `2022-02-05`,
				who: `J. Micheal Henderson`,
				source: `Phone Conversation`,
				said: <>
				<p>
				Mike Murphy (REO Speedwagon), and Carl Story (Faith Band) appeared on this demo.
				</p>
				<p>
				All 4 tracks appear on the CD release of "Nite People".
				</p>
				<p>
				3 of these tracks replace the original LP versions on the CD (due to the vocalist perferring these performances).
				</p>
				</>,
			},
		],
