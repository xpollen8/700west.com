...
const Photos = () => (
	...
	<p>
	<a href={`/images/moeshot_1976.jpg`}><Image
	...
	<p>
	<a href={`/images/Mo_machines.jpg`}><Image
		src={`/images/Mo_machines_500.jpg`}
					width="500" height="730" border="1" alt="moe, 1976" /></a>
	</p>
	<p>
	<a href={`/images/MoetheHippie1972.jpg`}><Image
	...
	<p>
		<a href={`/images/moe_1974.jpg`}><Image
	...
	<p>
		<a href={`/images/procdrumkit.jpg`}><Image
	...
	<p>
		<a href={`/images/kev700west.jpg`}><Image
