...
const History = () => (
	...
	<p>
	 <div style={{ display: 'inline-block', float: 'right' }} >
		<Image src={`${process.env.NEXT_PUBLIC_IMAGES}/250_business_card.jpg`} width="250" height="147" border="0" />
	</div>
	...
	<div style={{ display: 'inline-block', float: 'left', padding: '10px' }}>
		<a href={`${process.env.NEXT_PUBLIC_IMAGES}/20161007_700WestTapes.jpg`}><Image src={`${process.env.NEXT_PUBLIC_IMAGES}/20161007_700WestTapes_500.jpg`} width="500" height="670" /></a>
	</div>
	<p>
